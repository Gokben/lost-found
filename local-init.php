...
$pdo->exec("CREATE TABLE IF NOT EXISTS items (id INTEGER PRIMARY KEY AUTOINCREMENT,item_no TEXT NOT NULL UNIQUE,serial_no TEXT DEFAULT '',related_items TEXT DEFAULT '',found_at TEXT NOT NULL,location TEXT NOT NULL,category TEXT NOT NULL,name TEXT NOT NULL,brand TEXT DEFAULT '',color TEXT DEFAULT '',details TEXT,storage_location TEXT DEFAULT '',found_department TEXT DEFAULT '',found_by TEXT DEFAULT '',quantity INTEGER NOT NULL DEFAULT 1,status TEXT NOT NULL DEFAULT 'Depoda',delivered_at TEXT DEFAULT NULL,delivery_method TEXT DEFAULT '',delivered_by TEXT DEFAULT '',delivery_form_no TEXT DEFAULT '',import_order INTEGER DEFAULT NULL,recorded_by TEXT NOT NULL,created_at TEXT DEFAULT CURRENT_TIMESTAMP)");
