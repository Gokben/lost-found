...
<label>Teslimat tarihi<input type="text" inputmode="numeric" pattern="\d{2}\.\d{2}\.\d{4}" placeholder="gg.aa.yyyy" name="delivered_at" value="<?=e($_POST['delivered_at'] ?? date_display($item['delivered_at']))?>"></label><label>Teslim şekli<input name="delivery_method" value="<?=field('delivery_method')?>"></label><label>Teslim eden<input name="delivered_by" value="<?=field('delivered_by')?>"></label><label>Teslim form no<input name="delivery_form_no" value="<?=field('delivery_form_no')?>"></label>
