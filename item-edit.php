...
<label>Teslimat tarihi<input type="date" name="delivered_at" value="<?=e(date_input_to_storage($_POST['delivered_at'] ?? $item['delivered_at'])??'')?>"></label><label>Teslim şekli<input name="delivery_method" value="<?=field('delivery_method')?>"></label><label>Teslim eden<input name="delivered_by" value="<?=field('delivered_by')?>"></label><label>Teslim form no<input name="delivery_form_no" value="<?=field('delivery_form_no')?>"></label>
