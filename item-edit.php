...
if ($readOnly) echo '<style>#item-form input,#item-form select,#item-form textarea,#item-form button{pointer-events:none}#item-form .save-button,#item-form .add-related-action,#item-form .item-images-field{display:none!important}</style>';
?>
