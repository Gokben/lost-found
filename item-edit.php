...
if ($readOnly) echo '<style>#item-form input,#item-form select,#item-form textarea,#item-form button{pointer-events:none}#item-form .save-button,#item-form .add-related-action,#item-form .item-images-field{display:none!important}.record-meta-field{grid-column:3 / -1!important;grid-row:4 / span 2;align-self:stretch}</style>';
?>
